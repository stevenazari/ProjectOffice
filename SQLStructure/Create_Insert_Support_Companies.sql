...
/****** Object:  StoredProcedure [dbo].[Create_Insert_Support_Companies]    Script Date: 02/01/2018 08:41:03 ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Creates insert procedure for Support_Companies table - ONLY USE FOR INSTALL
-- =============================================
CREATE PROCEDURE [dbo].[Create_Insert_Support_Companies] 
AS
BEGIN
	exec('
		CREATE PROCEDURE Insert_Support_Companies(
			@ID int = NULL,
			@Get_All INT = NULL,
			@Name NVARCHAR(50),
